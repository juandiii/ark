...
public @interface RegisterArkClient {
     ...
     * Classes implementing {@link xyz.juandiii.ark.core.interceptor.RequestInterceptor}
     * are added as request interceptors.
     * Classes implementing {@link xyz.juandiii.ark.core.interceptor.ResponseInterceptor}
